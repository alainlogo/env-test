...
{block name="input"}
    {if $input.type == 'design'}
        ...
        <script>
            $(function(){
                $('label[for=TB_DISPLAY_NR_OF_ITEMS_off], label[for=TB_DISPLAY_NR_OF_ITEMS_on]').click(function(e){
                    if($(this).attr('for') == 'TB_DISPLAY_NR_OF_ITEMS_off') {
                        $('#TB_INDICATOR_DESIGN_none').prop('disabled', true);
                    } else {
                        $('#TB_INDICATOR_DESIGN_none').prop('disabled', false);
                    }

                    if($('#TB_INDICATOR_DESIGN_none').is(':checked')) {
                        $('#TB_INDICATOR_DESIGN_bar').prop('checked', true);
                    }
                });
            });
        </script>
