...
$(document).ready(function(){
	...
	$('.tbcmstestimonial .tbcmsdelete').click(function(e){
		e.preventDefault();
	...
	function removeTags(){
    	setTimeout(function() {
          $(".tbcmstestimonial-position-update").remove();
        }, 3000);
    }

	var url = baseDir + "modules/tbcmstestimonial/ajax.php";
    var obj = $(document).find('body');
    $(".tbcmstestimonial tbody").sortable({
        opacity: 0.6,
        cursor: 'move',
        update: function() {
            ...
            $.post(url, order, function(data) {
                ...
                if (result == 'right') {
                    var tags = '';
                    tags += '<div id="growls" class="default tbcmstestimonial-position-update"><div class="growl growl-notice growl-medium">';
