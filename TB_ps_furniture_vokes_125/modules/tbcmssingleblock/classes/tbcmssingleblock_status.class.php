...
class TbcmsSingleBlockStatus extends Module
{
    public function fieldStatusInformation()
    {
        ...
        $result['single_block_image_2'] = false;
        $result['single_block_image_3'] = false;
        $result['single_block_image_4'] = false;
        $result['single_block_title'] = true;
        $result['single_block_sub_title'] = false;
