                        ...
                        <div class="dummyfile input-group">
                            ...
                            <span class="input-group-btn">
                                <button id="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
                                    <i class="icon-folder-open"></i> {l s='Choose a file' mod='tbcmsmultibanner1'}
                                </button>
                            </span>
                        </div>
                    </div>
    ...
    {if $input.type == 'multiple_select'}
        <div class="col-lg-9">
            {foreach from=$languages item=language}
                ...
                <div class="form-group">
                    <div class="col-lg-3">
                        ...
                        <select name="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}">
                            <option value='left' {if $value == 'left'}selected="selected"{/if}>{l s='Left' mod='tbcmsmultibanner1'}</option>
                            <option value='center' {if $value == 'center'}selected="selected"{/if}>{l s='Center' mod='tbcmsmultibanner1'}</option>
                            <option value='right' {if $value == 'right'}selected="selected"{/if}>{l s='Right' mod='tbcmsmultibanner1'}</option>
                            <option value='none' {if $value == 'none'}selected="selected"{/if}>{l s='None' mod='tbcmsmultibanner1'}</option>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    <div id="{$input.name|escape:'htmlall':'UTF-8'}-{$language.id_lang|escape:'htmlall':'UTF-8'|escape:'htmlall':'UTF-8'}-images-thumbnails" class="col-lg-12">
                        <p class="help-block">{l s='Select Caption Side' mod='tbcmsmultibanner1'}</p>
                    </div>
                </div>
