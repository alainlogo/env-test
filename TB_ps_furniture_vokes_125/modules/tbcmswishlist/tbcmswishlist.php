...
class TbcmsWishList extends Module
{
    const INSTALL_SQL_FILE = 'install.sql';
    private $html = '';
    public function __construct()
    {
        $this->name = 'tbcmswishlist';
        ...
        $this->bootstrap = true;
        parent::__construct();
        $this->displayName = $this->l('TemplateBeta - Wishlist block');
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('viewtbcmswishlist') && $id = Tools::getValue('id_product')) {
    ...
    public function hookdisplayProductListFunctionalButtons($params)
    {
        ...
        return $this->display(__FILE__, 'views/templates/front/tbcmswishlist_button.tpl');
    }

    public function hookdisplayNavWishlistBlock($params)
    {
        $this->headerData();
        return  $this->display(__FILE__, 'views/templates/front/tbcmswishlist_top.tpl');
    }
    ...
    public function hookdisplayWishlistBtnSticky($params)
    {
        ...
        return $this->display(__FILE__, 'views/templates/front/tbcmswishlist_top_3.tpl');
    }
    ...
    public function hookdisplayNavWishlistMobileBlock($params)
    {
        ...
        return $this->display(__FILE__, 'views/templates/front/tbcmswishlist_top_2.tpl');
    }

    public function hookdisplayHeader($params)
    {
        $this->context->controller->addCSS(($this->_path).'views/css/tbcmswishlist.css', 'all');
        $this->context->controller->addJS(($this->_path).'views/js/ajax-wishlist.js');

        $this->smarty->assign(array(
            'wishlist_link' => $this->context->link->getModuleLink('tbcmswishlist', 'mywishlist')
        ));
    }
    public function hookrightColumn($params)
    {
        ...
        return ($this->display(__FILE__, 'views/templates/front/tbcmswishlist.tpl'));
    }
    ...
    public function hookProductActions($params)
    {
        ...
        return ($this->display(__FILE__, 'views/templates/front/tbcmswishlist-extra.tpl'));
    }
