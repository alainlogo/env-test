                    ...
                    <div class="blog_post_content tbblog-event-all-content-block">
                        ...
                        <div class="post_content">
                            ...
                            <div class="post_meta clearfix tbblog-date-username">
                                <p class="meta_author">
                                    {l s='By ' mod='tbcmsblog'} {$tbcmsblgpst.post_author_arr.firstname} {$tbcmsblgpst.post_author_arr.lastname}
                                </p>
                                <p class="meta_date">
                                    {* <i class='material-icons'>&#xe916;</i> *}
                             ...
                             <div class="tbnews-event-titel"><a href="{$tbcmsblgpst.link}" class="post_title"><h3>{$meta_title}</h3></a></div>
