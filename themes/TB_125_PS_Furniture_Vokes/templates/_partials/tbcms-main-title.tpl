	...
	<div class='tbcmsmain-title-wrapper clearfix'>
		<div class="tbcms-main-title">
			{if $main_heading['main_sub_title']}
				<div class='tbmain-sub-title'><h4>{$main_heading['data']['short_desc']}</h4></div>
			{/if}

			{if $main_heading['main_title']}
				<div class='tbmain-title'><h2>{$main_heading['data']['title']}</h2></div>
			{/if}
			
			{if $main_heading['main_description']}
				<div class='tbmain-desc'>{$main_heading['data']['desc']}</div>
			{/if}
			
			{if $main_heading['main_title_1']}
				<div class='tbmain-title'><h2>{l s ="Collection"}</h2></div>
			{/if}
