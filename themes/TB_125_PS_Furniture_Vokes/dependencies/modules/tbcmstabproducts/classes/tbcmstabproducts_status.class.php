...
class TbcmsTabProductsStatus extends Module
{
    public function fieldStatusInformation()
    {
        ...
        $result['featured_prod']['home_sub_title'] = true;
        ...
        $result['featured_prod']['home_image_link'] = true;
        ...
        $result['new_prod']['home_sub_title'] = true;
        ...
        $result['new_prod']['home_image_link'] = true;
        ...
        $result['best_seller_prod']['home_sub_title'] = true;
        ...
        $result['best_seller_prod']['home_image_link'] = true;
        ...
        $result['special_prod']['home_sub_title'] = true;
        ...
        $result['special_prod']['home_image_link'] = true;
