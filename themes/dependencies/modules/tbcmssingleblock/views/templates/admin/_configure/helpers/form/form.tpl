    ...
    {if $input.type == 'image_file'}
        <div class="col-lg-9">
            {foreach from=$languages item=language}
                        ...
                        <div class="dummyfile input-group">
                            ...
                            <span class="input-group-btn">
                                <button id="{$input.name|escape:'htmlall':'UTF-8'}_{$language.id_lang|escape:'htmlall':'UTF-8'}-selectbutton" type="button" name="submitAddAttachments" class="btn btn-default">
                                    <i class="icon-folder-open"></i> {l s='Choose a file' mod='tbcmssingleblock'}
                                </button>
                            </span>
                        </div>
                    </div>
                ...
                {assign var='width' value='93'}
                {assign var='height' value='93'}
                ...
                <div class="form-group">
                    <div id="{$input.name|escape:'htmlall':'UTF-8'}-{$language.id_lang|escape:'htmlall':'UTF-8'|escape:'htmlall':'UTF-8'}-images-thumbnails" class="col-lg-12">
                        <img src="{$path|escape:'htmlall':'UTF-8'}{$fields_value[$input.name][$language.id_lang]|escape:'htmlall':'UTF-8'}" class="img-thumbnail" width='200px'/>
                        <p class="help-block">{l s='Please Select Image.' mod='tbcmssingleblock'} (Size:- {$width|escape:'htmlall':'UTF-8'} X {$height|escape:'htmlall':'UTF-8'})</p>
                    </div>
                </div>
    ...
    {if $input.type == 'image_file_2'}
        <div class="col-lg-9">
            {foreach from=$languages item=language}
                ...
                {assign var='width' value='558'}
                {assign var='height' value='660'}
    ...
    {if $input.type == 'image_file_3'}
        <div class="col-lg-9">
            {foreach from=$languages item=language}
                ...
                {assign var='width' value='444'}
                {assign var='height' value='130'}
    ...
    {if $input.type == 'image_file_4'}
        <div class="col-lg-9">
            {foreach from=$languages item=language}
                ...
                {assign var='width' value='69'}
                {assign var='height' value='68'}
