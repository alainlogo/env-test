...
{block name='page_header_container'}
    <header class="page-header tbpage-header-title-wrapper">
        <h1 class="tbpage-header-title">{$tbcmsblogpost.post_title}</h1>
    </header>
{/block}
			...
			<article class="blog_post blog_post_{$tbcmsblogpost.post_format} clearfix">
				<div class="blog_post_content">
					...
					<div class="post_content col-xl-7 col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="tbnews-event-titel"><a href="{$tbcmsblgpst.link}" class="post_title"><h3>{$tbcmsblogpost.post_title}</h3></a></div>
						<div class="post_meta clearfix tbblog-date-username">
							<p class="meta_author">
								{l s='By ' mod='tbcmsblog'} {$tbcmsblogpost.post_author_arr.firstname} {$tbcmsblogpost.post_author_arr.lastname} 
							</p>
							<p class="meta_date">
