...
class Ht_Staticblocks extends Module {
    ...
    public function hookdisplayFooterBottomLink() {
        if (!$this->isCached('module:ht_staticblocks/views/templates/hook/ht_staticblocks_footerbottomlink.tpl', $this->getCacheId('ht_staticblocks_footerbottomlink'))) {
            $block_list = $this->getBlockFromHook('displayFooterBottomLink');
            $this->context->smarty->assign(array(
                'block_list' => $block_list,
                'page_name' => $this->context->controller->php_self
            ));
        }
        return $this->display(__FILE__, 'ht_staticblocks_footerbottomlink.tpl', $this->getCacheId('ht_staticblocks_footerbottomlink'));
    }

    public function hookdisplayNav1() {
        if (!$this->isCached('module:ht_staticblocks/views/templates/hook/ht_staticblocks_displayNav1.tpl', $this->getCacheId('ht_staticblocks_displayNav1'))) {
        ...
        return $this->display(__FILE__, 'ht_staticblocks_displayNav1.tpl', $this->getCacheId('ht_staticblocks_displayNav1'));
    }
