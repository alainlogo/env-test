...
<div class="container-fluid">
    <div class="tbcmstop-outer-wrapper"> 
        {hook h='displaySocialMediaBlock'}
        <div class="tbcms-slider-offerbanner-wrapper">
            <div class="tbcmsmain-slider-wrapper" data-speed='{$main_slider_js.speed}' data-pause-hover='{$main_slider_js.pause}'>
