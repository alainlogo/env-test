...
*}
{strip}
<div class="tb-indicator tb-battery{if $useProgressiveColors} tb-colors{/if}">
    <div class="tb-outer" data-toggle="tbtooltip" data-placement="top" data-html="true" {if isset($stockLevelStatus)}title="<div class='text-center'>{$stockIndicatorTrans.stockStatus|escape:'html':'UTF-8'}: <b>{$stockLevelStatus|escape:'html':'UTF-8'}</b></div>"{/if} >
        <div class="tb-inner tb-lvl-{$stockLevel|escape:'html':'UTF-8'}">
            <span class="tb-battery-1"></span>
            <span class="tb-battery-2"></span>
            <span class="tb-battery-3"></span>
            <span class="tb-battery-4"></span>
            <span class="tb-battery-5"></span>
        </div>
    </div>
