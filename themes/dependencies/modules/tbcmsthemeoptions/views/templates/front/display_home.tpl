				...
				<tr class="tbselect-theme tball-theme-content">
					<td>
						...
						<select class="tbselect-theme-select" id="select_theme">
							...
							<option value="theme2" data-color="#ff6262" data-color-two="#d61e1e">{l s='Theme 2' d='Shop.Theme.Global'}</option>
							<option value="theme3" data-color="#3b96ff" data-color-two="#f05a66">{l s='Theme 3' d='Shop.Theme.Global'}</option>
							<option value="theme4" data-color="#acb322" data-color-two="#c7c702">{l s='Theme 4' d='Shop.Theme.Global'}</option>
