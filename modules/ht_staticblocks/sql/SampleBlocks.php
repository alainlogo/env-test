...
class SampleBlocks {
    ...
    public function initData($base_url) {
        ...
        $content_block1 = '<div class="ht-static-block offer-block top-margin bottom-margin">
    <div class="container">
        <div class="row">
            <div class="item">
                <div class="item-inner"><a href="#"> <img class="img-responsive center-block" src="img/cms/adv-img-1.jpg" alt="adv-img-1" /> </a>
                    <div class="text-content">
                        <p><strong>WOMEN</strong> <br />Collections</p>
                        <a class="action primary btn btn-primary" href="#"> Shop Now </a>
                    </div>
                </div>
            </div>
            <div class="item">
                <div class="item-inner"><a href="#"> <img class="img-responsive center-block" src="img/cms/adv-img-2.jpg" alt="adv-img-2" /> </a>
                    <div class="text-content">
                        <p><strong>MEN</strong> <br />Collections</p>
                        <a class="action primary btn btn-primary" href="#"> Shop Now </a>
                    </div>
                </div>
            </div>
...
';
        $content_block2 = '<div class="ht-static-block testimonial-block">
    <div class="container">
                ...
                <div class="item">
                    <div class="item-inner">
                        <div class="text-block">
                            ...
                            <div class="img-block"><img src="img/cms/testimonial-img-1.jpg" alt="testimonial-img-1" /></div>
                            <span class="name">Alina Doe</span> <span class="designation">Customer</span>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="item-inner">
                        <div class="text-block">
                            <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem doloremque. Laudantium totam rem aperiam, eaque ipsa quae unde error accusantium unde error accusantium unde.</p>
                            <div class="img-block"><img src="img/cms/testimonial-img-2.jpg" alt="testimonial-img-1" /></div>
                            <span class="name">Keonel Lee</span> <span class="designation">Fashion Designer</span>
                        </div>
                    </div>
                </div>
            </div>
...
';
        ...
        $content_block3 = '<div id="blog-section" class="ht-home-blogs slider-block">
    <div class="container">
        <div class="section-title">
            <h2>
                <span>
...
';
        ...
        $content_block5 = '<div class="header-msg-block">
