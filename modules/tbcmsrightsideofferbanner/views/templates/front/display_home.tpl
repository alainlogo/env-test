...
<div class="tbcmsrightsideofferbanners-one">
    <div class="tbbanner1 tbone-banner-wrapper-info">
        <a href="{$data['TBCMSRIGHTSIDEOFFERBANNER_LINK']}" class="tbbanner-hover-wrapper" title="{$data['TBCMSRIGHTSIDEOFFERBANNER_CAPTION'][$language_id]}">
        ...
        {if $data['TBCMSRIGHTSIDEOFFERBANNER_CAPTION_SIDE'] != "none" }
