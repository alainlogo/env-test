 ...
 */
class Ps_checkout2155AdminContainer extends Container
{
    private $parameters = [];
    private $targetDirs = [];
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.2', 'C:\\wamp64\\www\\test-ab', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.8.2', 'C:\\wamp64\\www\\test-ab');
    }
